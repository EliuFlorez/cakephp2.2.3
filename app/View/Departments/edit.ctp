...
<div id="page-heading"><h1>Edit Department</h1></div>
...
<tr>
	...
	<td>
		...
		<div id="step-holder">
			...
			<div class="step-dark-left"><a href="">Edit department details</a></div>
			...
			<tr>
				...
				<td>
				   <?php
				     ...
				     echo $this->Form->input('company_id',array('class'=>'styledselect_form_1'));
				   ?>
				</td>
				<td>
