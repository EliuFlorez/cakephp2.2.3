	...
	<tr>
		...
		<div id="content-table-inner">
		  ...
		  <!--  start product-table ..................................................................................... -->
				...
				<tr>
					...
					<th class="table-header-repeat line-left minwidth-1"><?php echo $this->Paginator->sort('company_id'); ?></th>
		...
		<?php foreach ($departments as $department): ?>
		       <tr>
					...
					<td><?php echo h($department['Company']['company_name']); ?>&nbsp;</td>
					...
					<td><?php echo h($department['Department']['modified']); ?>&nbsp;</td>
     				...
     				<td class="options-width">
						<?php echo $this->Html->link('', array('action' => 'view', $department['Department']['id']),array('class'=>'icon-1 info-tooltip','title'=>'View')); ?>
						<?php echo $this->Html->link('', array('action' => 'edit', $department['Department']['id']),array('class'=>'icon-3 info-tooltip','title'=>'Edit')); ?>
						<?php echo $this->Form->postLink('', array('action' => 'delete', $department['Department']['id']), array('class'=>'icon-2 info-tooltip', 'title'=>'delete'), __('Are you sure you want to delete # %s?', $department['Department']['id'])); ?>
					</td>
				</tr>
		<?php endforeach; ?>
