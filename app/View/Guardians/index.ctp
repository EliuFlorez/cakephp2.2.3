...
<?php  //echo "<pre>"; print_r($guardians[0]); exit(); ?>
	<!--  start page-heading -->
	<div id="page-heading">
		<h1>Parents</h1>
	</div>
	...
	<tr>
		...
		<?php foreach ($guardians as $guardian):?>
		       <tr>
		       		<td><?php echo h($guardian['User']['id']); ?>&nbsp;</td>
		       		<td><?php echo h($guardian['User']['first_name']); ?>&nbsp;</td>
					<td><?php echo h($guardian['User']['last_name']); ?>&nbsp;</td>
					<td><?php echo h($guardian['User']['email_address']); ?>&nbsp;</td>
					<td><?php echo h($guardian['Guardian']['qualification']); ?>&nbsp;</td>
									
     				<td class="options-width">
						<?php echo $this->Html->link('', array('action' => 'view', $guardian['User']['id']),array('class'=>'icon-1 info-tooltip','title'=>'View')); ?>
						<?php echo $this->Html->link('', array('action' => 'edit', $guardian['User']['id']),array('class'=>'icon-3 info-tooltip','title'=>'Edit')); ?>
						<?php echo $this->Form->postLink('', array('action' => 'delete', $guardian['User']['id']), array('class'=>'icon-2 info-tooltip', 'title'=>'delete'), __('Are you sure you want to delete # %s?', $guardian['User']['id'])); ?>
					</td>
				</tr>
		<?php endforeach; ?>
