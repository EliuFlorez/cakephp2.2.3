...
<?php  //echo "<pre>"; print_r($students[0]); exit(); ?>
	<!--  start page-heading -->
	<div id="page-heading">
		<h1>Students</h1>
	</div>
	...
	<tr>
		...
		<?php foreach ($students as $student):?>
		       <tr>
		       		<td><?php echo h($student['User']['id']); ?>&nbsp;</td>
		       		<td><?php echo h($student['Standard']['standard_name']); ?>&nbsp;</td>
					<td><?php echo h($student['Division']['division_name']); ?>&nbsp;</td>
					<td><?php echo h($student['User']['first_name']); ?>&nbsp;</td>
					<td><?php echo h($student['User']['last_name']); ?>&nbsp;</td>
					
									
     				<td class="options-width">
						<?php echo $this->Html->link('', array('action' => 'view', $student['User']['id']),array('class'=>'icon-1 info-tooltip','title'=>'View')); ?>
						<?php echo $this->Html->link('', array('action' => 'edit', $student['User']['id']),array('class'=>'icon-3 info-tooltip','title'=>'Edit')); ?>
						<?php echo $this->Form->postLink('', array('action' => 'delete', $student['User']['id']), array('class'=>'icon-2 info-tooltip', 'title'=>'delete'), __('Are you sure you want to delete # %s?', $student['User']['id'])); ?>
					</td>
				</tr>
		<?php endforeach; ?>
