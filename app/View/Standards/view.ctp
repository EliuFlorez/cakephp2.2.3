...
<div id="page-heading"><h1>Standard</h1></div>
...
<tr>
	...
	<td>
		...
		<div id="step-holder">
			...
			<div class="step-dark-left"><a href="">View Standard Details</a></div>
		...
		<table border="0" cellpadding="0" cellspacing="0"  id="id-form">
			...
			<tr>
				...
				<td><?php echo $standard['Standard']['id']; ?></td>
				<td>
			...
			<tr>
				...
				<td><?php echo $this->Html->link($standard['School']['school_name'], array('controller' => 'schools', 'action' => 'view', $standard['School']['id'])); ?></td>
				<td>
			...
			<tr>
				...
				<td><?php echo $standard['Standard']['standard_name']; ?></td>
				<td></td>
			</tr>	
						
			<tr>
				<th valign="top">Created:</th>
				<td><?php echo $standard['Standard']['created']; ?></td>
				<td></td>
			</tr>
			
			<tr>
				<th valign="top">Updated:</th>
				<td><?php echo $standard['Standard']['modified']; ?></td>
				<td></td>
			</tr>
...
<div class="related">
	...
	<div class="actions">
		<ul>
			<li><?php echo $this->Html->link(__('New Division'), array('controller' => 'users', 'action' => 'add')); ?> </li>
		</ul>
	</div>
	<?php if (!empty($standard['Division'])): ?>
	
	<!--  start product-table ..................................................................................... -->
				
				<table border="0" width="100%" cellpadding="0" cellspacing="0" id="product-table">
				<tr>
					<th class="table-header-check"><a href=""><?php echo __('Division Id'); ?></a></th>
		...
		<?php $i = 0; foreach ($standard['Division'] as $user): ?>
		      <tr>
				...
				<td class="actions">
					...
					<?php echo $this->Html->link('', array('controller' => 'standards','action' => 'view', $user['id']),array('class'=>'icon-1 info-tooltip','title'=>'View')); ?>
					<?php echo $this->Html->link('', array('controller' => 'standards','action' => 'edit', $user['id']),array('class'=>'icon-3 info-tooltip','title'=>'Edit')); ?>
					<?php echo $this->Form->postLink('', array('controller' => 'standards','action' => 'delete', $user['id']), array('class'=>'icon-2 info-tooltip', 'title'=>'delete'), __('Are you sure you want to delete # %s?', $user['id'])); ?>
