...
<div id="page-heading"><h1>Add User Group</h1></div>
...
<tr>
	...
	<td>
		...
		<div id="step-holder">
			...
			<div class="step-dark-left"><a href="">Add User Group details</a></div>
	...
	<?php echo $this->Form->create('Group', array(
	 ...
	 ?>	
		<table border="0" cellpadding="0" cellspacing="0"  id="id-form">
			...
			<tr>
				<th valign="top">User Group Name :</th>
				<td><?php echo $this->Form->input('group_name'); ?></td>
				<td>
			...
			<tr>
				...
				<td><?php echo $this->Form->input('slug'); ?></td>
				<td></td>
			</tr>	
