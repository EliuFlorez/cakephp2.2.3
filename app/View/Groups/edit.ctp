...
<div id="page-heading"><h1>Edit Group</h1></div>
...
<tr>
	...
	<td>
		...
		<div id="step-holder">
			...
			<div class="step-dark-left"><a href="">Edit Group details</a></div>
	...
	<?php echo $this->Form->create('Group', array(
	 ...
	 ?>	
		<table border="0" cellpadding="0" cellspacing="0"  id="id-form">
		    ...
		    <tr>
				<th valign="top">Allow Register :</th>
				<td>
				   <?php
				     
				     echo $this->Form->input('allow_register');
				   ?>
				</td>
				<td>
