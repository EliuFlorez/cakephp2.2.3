...
<div id="page-heading"><h1>Company</h1></div>
...
<tr>
	...
	<td>
		...
		<div id="step-holder">
			...
			<div class="step-dark-left"><a href="">View company details</a></div>
		...
		<table border="0" cellpadding="0" cellspacing="0"  id="id-form">
			...
			<tr>
				...
				<td><?php echo $company['Company']['registration_number']; ?></td>
				<td></td>
			</tr>	
			<tr>
...
<div class="related">
	...
	<!--  start product-table ..................................................................................... -->
				...
				<tr>
					...
					<th class="table-header-repeat line-left minwidth-1"><a href=""><?php echo __('Department name'); ?></a></th>
		...
		<?php $i = 0; foreach ($company['Department'] as $department): ?>
		      <tr>
				...
				<td class="actions">
					...
					<?php echo $this->Html->link('', array('controller' => 'departments','action' => 'view', $department['id']),array('class'=>'icon-1 info-tooltip','title'=>'View')); ?>
					<?php echo $this->Html->link('', array('controller' => 'departments','action' => 'edit', $department['id']),array('class'=>'icon-3 info-tooltip','title'=>'Edit')); ?>
					<?php echo $this->Form->postLink('', array('controller' => 'departments','action' => 'delete', $department['id']), array('class'=>'icon-2 info-tooltip', 'title'=>'delete'), __('Are you sure you want to delete # %s?', $department['id'])); ?>
